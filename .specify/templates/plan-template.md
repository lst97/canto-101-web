...
### I. Component-First Compliance

- [ ] Feature starts as reusable React component
- [ ] Component is independently testable and documented
...
- [ ] Full type coverage enforced

### III. Test-First (NON-NEGOTIABLE)

- [ ] Tests written before implementation
- [ ] Red-Green-Refactor cycle followed
- [ ] Unit tests for components, integration for features
...
**Status**: [PASS/FAIL] - [Justification if FAIL]
...
5. **Update agent file incrementally** (O(1) operation):
   - Run `.specify/scripts/bash/update-agent-context.sh copilot` for your AI
     assistant
