...
import { LyricPronunciationSearch } from "@/components/cantoLyr/lyrics-search";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function CantoLyrLyricPronunciationSearch(): ReactElement {
  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-8 px-6 pb-24 pt-16 md:px-10 md:pt-20">
      <div className="flex flex-col gap-6">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>{t("cantoLyr.lyricSearch.nav.pron")}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      ...
      <section aria-label={t("cantoLyr.lyricSearch.pron.tipsHeading")} className="space-y-4">
      ...
      <section aria-label={t("cantoLyr.lyricSearch.pron.heading")} className="space-y-4">
        <div className="space-y-2">
