...
export function Header(): ReactElement {
  ...
  const smoothScrollToId = useCallback((id: string): void => {
    ...
    if ('scrollIntoView' in element) {
      ...
      const targetY = window.scrollY + (element as HTMLElement).getBoundingClientRect().top
  ...
  const handleProductsMenuOpenChange = useCallback((nextOpen: boolean): void => {
  ...
  useEffect(() => {
    const ids = ['program-overview', 'getting-started', 'resources', 'community', 'products']
    const elements = ids
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3 md:px-10">
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <div className="hidden lg:block">
            <Separator orientation="vertical" className="mx-3 inline-block h-6" />
          </div>
                ...
                <NavigationMenuItem key={l.key}>
                  <NavigationMenuLink asChild>
                    <a
                      ...
                      aria-current={activeId && l.href === `#${activeId}` ? 'page' : undefined}
                      className={[
                ...
                <DropdownMenu onOpenChange={handleProductsMenuOpenChange}>
                  <DropdownMenuTrigger asChild>
                    <button
                      ...
                      className={[
                        ...
                        isOnProducts ? 'text-foreground' : 'text-muted-foreground hover:text-foreground',
                      ].join(' ')}
                  ...
                  <DropdownMenuContent
                    ...
                    onCloseAutoFocus={(event: Event) => {
                      ...
                      productsTriggerRef.current?.focus({ preventScroll: true })
                    }}
                  >
                    <DropdownMenuItem asChild>
                      <Link
                        ...
                        className={isOnCantoLyr ? 'font-semibold text-foreground' : undefined}
                      >
                    ...
                    <DropdownMenuItem asChild>
                      <Link
                        ...
                        className={isOnCantoCap ? 'font-semibold text-foreground' : undefined}
                      >
