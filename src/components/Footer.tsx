      ...
      <footer className="mt-24 border-t-8 border-primary bg-primary/10 text-primary">
        <div className="mx-auto max-w-6xl px-6 py-12 md:px-10">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <section>
              <h3 className="text-lg font-semibold">{t('footer.sections.gettingStarted.title')}</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold">{t('footer.sections.resources.title')}</h3>
              <ul className="mt-3 space-y-2 text-primary/80">
            ...
            <section>
              <h3 className="text-lg font-semibold">{t('footer.sections.community.title')}</h3>
              <ul className="mt-3 space-y-2 text-primary/80">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div>
              <h3 className="text-lg font-semibold">{t('footer.sections.products.title')}</h3>
        ...
        <div className="mx-auto max-w-6xl px-6 py-8 md:px-10">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <ul className="flex gap-4">
              <li><a href="#" className="hover:underline">{t('footer.sections.legal.terms')}</a></li>
              <li><a href="#" className="hover:underline">{t('footer.sections.legal.privacy')}</a></li>
              <li><a href="#" className="hover:underline">{t('footer.sections.legal.accessibility')}</a></li>
            </ul>
