...
import { LyricSearchBase, type FilterFieldConfig } from "./LyricSearchBase";
...
const filterFields: FilterFieldConfig[] = [
  {
    ...
    inputProps: { type: "number", inputMode: "numeric", min: 1, max: 50, step: 1 },
  },
  {
    key: "position",
  ...
  },
  {
    ...
    inputProps: { type: "number", inputMode: "numeric", min: 1900, max: 2100, step: 1 },
  },
];
