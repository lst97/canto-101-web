...
export const useTranslationEditor = () => {
  ...
  const setSearchTerm = useTranslationEditorStore(state => state.setSearchTerm);
  const searchMode = useTranslationEditorStore(state => state.searchMode);
  const setSearchMode = useTranslationEditorStore(state => state.setSearchMode);
  ...
  const expandedNodes = useTranslationEditorStore(state => state.expandedNodes);
  ...
  const sourceOfTruth = useTranslationEditorStore(state => state.sourceOfTruth);
  ...
  const resetLanguage = useTranslationEditorStore(state => state.resetLanguage);
